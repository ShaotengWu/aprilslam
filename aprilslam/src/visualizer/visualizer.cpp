...
namespace aprilslam
{
    ...
    void ApriltagVisualizer::PublishApriltagsMarker(const aprilslam::Apriltags &apriltags)
    {
        PublishApriltagsMarker(apriltags.apriltags, apriltags.header.frame_id, apriltags.header.stamp);
    }
